...
<div class="row py-5">
  <div class="col-6 py-5 mt-3">
    <div class="desc ml-5">
      <h2 class="text-gray-800" data-aos="fade-down">Selamat datang di website pengaduan troubleshooting jaringan</h2>
      <p data-aos="fade-down">Website ini dibuat untuk melihat laporan pengaduan troubleshooting dan menjawab
