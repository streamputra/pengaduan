...
$title = 'pengaduan troublshooting jaringan';
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary py-3 shadow">
  <div class="container" data-aos="fade-down">
    <a class="navbar-brand" href="#">
      <i class="fas fa-atlas"></i> Pengaduan Troubleshooting Jaringan
    </a>
...
<div class="bg-gradient-primary" style="border-bottom-right-radius: 100px; border-bottom-left-radius: 100px; padding:150px;">
  <div class="container d-flex justify-content-center" data-aos="zoom-in">
    <div class="text-center col-8 text-light" style="margin-top: -25px;">
      <h1>pengaduan troubleshooting jaringan </h1>
      <p>website pengaduan troubleshooting jaringan BMKG Pusat instrumentasi jaringan komunikasi dan internet</p>
      ...
      <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-duration="900">
        <div class="card border-left-warning border-bottom-warning shadow-lg h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col ml-3">
                <div class="h5 mb-0 font-weight-bold text-warning">5 Akun pengaduan</div>
              </div>
      ...
      <div class="row">
        <div class="col-6" data-aos="fade-right">
          <div class="desc" style="margin-top: 130px;">
            <h4 class="text-justify text-gray-900">Buat laporan, aduan dan keluh kesah anda di website pengaduan troubleshooting jaringan ini dan jangan meyebarkan laporan hoax demi kenyamanan bersama</h4>
          </div>
        </div>
        <div class="col-6">
        ...
        <div class="col-6" style="margin-top: -45px;">
          <div class="desc" style="margin-top: 130px;" data-aos="fade-right">
            <h4 class="text-justify text-gray-900">Setelah menyapaikan laporan, aduan atau keluh kesah anda dapat menunggu tanggapan.</h4>
          </div>
        </div>
...
<div class="bg-gradient-primary py-5">
  <div class="container text-center text-light">
    <h1 class="mb-3">Info pengaduan troubleshooting jaringan</h1>
    <a href="mailto:geoffrey04putra@gmail.com" class="btn btn-light mr-1">Chat admin</a>
    <a href="mailto:geoffrey04putra@gmail.com" class="btn btn-outline-light ml-1">Contact Developer</a>
  </div>
</div>
    ...
    <div class="col-4">
      <div class="card shadow-sm" data-aos="fade-up" data-aos-duration="500">
        <div class="card-body">
          ...
          <span>Geoffrey Putra</span> |
          <span>Web Developer</span>
          <hr>
          <div class="card-text text-justify">" harapan saya setelan website ini dibuat bisa digunakan dengan baik dan sesuai dengan kegunaan dilapangan serta lingkungan BMKG Pusat  "</div>
        </div>
      </div>
    </div>
    <div class="col-4">
      <div class="card shadow-sm" data-aos="fade-up" data-aos-duration="700">
        <div class="card-body">
          ...
          <span>Adinda jaelani</span> |
          <span> Pegawai BMKG deputi instrumentasi  </span>
          <hr>
          <div class="card-text text-justify">"Website ini bagus dan sangat informatif dalam pembuatan laporan troubleshooting dilapangan  "</div>
        </div>
      </div>
    </div>
    <div class="col-4">
      <div class="card shadow-sm" data-aos="fade-up" data-aos-duration="900">
        <div class="card-body">
          ...
          <span>Abdurahmman sidik</span> |
          <span>IT Support </span>
          <hr>
          <div class="card-text text-justify">" website ini memudahkan kami sebagai IT Support dalam berkerja dan mengetahui problem troubleshooting apa saja. "</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="bg-gray-400 py-3">
  <footer>
    <div class="text-center mt-2 text-gray-700">
      <h6>Copyright Geoffrey putra 2023</h6>
    </div>
  </footer>
</div>
