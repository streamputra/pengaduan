		...
		<div class="card-body">
			<?php if (isset($sukses)) : ?>
				<div class="alert alert-dismissible fade show" data-aos="zoom-in" style="background-color: #3bb849;" role="alert">
					<h6 class="text-gray-100 mt-2">Berhasil menanggapi, Terima kasih sudah menanggapi pengaduan </h6>
						...
						<form action="" method="POST">
							...
							<div class="form-group">
								<select name="id_petugas" id="petugas" class="form-control">
									...
									<option value="1">indrasta rabbani </option>
									<option value="2">daniswara</option>
									<option value="3">farrel</option>
									<option value="4">rio fadhil</option>
									<option value="4">rafa raditya</option>
								</select>
							</div>
